      ...
      style={{backgroundColor: "#ad5b5b"}}>
        ...
        >
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/home" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
              Home
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/browse-categories" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
              Browse Categories
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/borrowed-books" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
            Borrowed Books
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/fine" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
              Payment & Fines
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/review-book" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
              Book Review
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/userProfile" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
              User Profile
            </Link>
          </Button>
          <Button variant="" className="mb-3 w-100 text-start">
            <Link to="/logout" style={{ textDecoration: "#c4c4c4", color: "inherit", display: "block", width: "100%" }}>
            Logout
            </Link>
          </Button>
        </aside>
