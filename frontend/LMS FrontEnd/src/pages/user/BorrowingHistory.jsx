...
const BorrowedBooks = () => {
  ...
  const booksData = [
    ...
    { id: 8, title: "Design Patterns", author: "Erich Gamma et al.", dueDate: "2025-03-10", status: "Borrowed" },
    { id: 9, title: "You Don’t Know JS", author: "Kyle Simpson", dueDate: "2025-02-25", status: "Overdue" },
    { id: 10, title: "JavaScript: The Good Parts", author: "Douglas Crockford", dueDate: "2025-02-18", status: "Returned" },
  ];
